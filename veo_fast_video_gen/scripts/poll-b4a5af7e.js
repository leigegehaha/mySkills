...
/**
 * 自动轮询脚本 - 任务ID: video_b4a5af7e-6280-4860-bf9c-5307e94d6540
 * 生成时间: 3/17/2026, 2:31:50 PM
 */
...
const TASK_ID = 'video_b4a5af7e-6280-4860-bf9c-5307e94d6540';

console.log('🎬 视频生成任务轮询');
console.log('任务ID:', TASK_ID);
console.log('提示词: 一个中国美女，跳性感舞蹈');
console.log('比例: 9:16');
console.log('');
