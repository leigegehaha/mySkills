...
/**
 * 自动轮询脚本 - 任务ID: video_92ba61e7-63fb-47f2-ab7a-3f8aecec9ced
 * 生成时间: 3/17/2026, 2:23:44 PM
 */
...
const TASK_ID = 'video_92ba61e7-63fb-47f2-ab7a-3f8aecec9ced';

console.log('🎬 视频生成任务轮询');
console.log('任务ID:', TASK_ID);
console.log('提示词: 美女跳性感舞蹈，然后一个后空翻，落入水中');
console.log('比例: 16:9');
console.log('');
