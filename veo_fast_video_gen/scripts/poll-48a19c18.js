...
/**
 * 自动轮询脚本 - 任务ID: video_48a19c18-f5d1-4587-a4c6-1d51ecba09ef
 * 生成时间: 3/11/2026, 9:35:40 PM
 */
...
const TASK_ID = 'video_48a19c18-f5d1-4587-a4c6-1d51ecba09ef';

console.log('🎬 视频生成任务轮询');
console.log('任务ID:', TASK_ID);
console.log('提示词: 一只可爱的柯基犬在草地上奔跑，阳光明媚');
console.log('比例: 16:9');
console.log('');
